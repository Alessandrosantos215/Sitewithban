...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'IGOREVEN'
...
def cadastrarUsuario():  
    ...
    with open('usuarios.json', 'w') as gravartTemp:
         json.dump(usuarioNovo, gravartTemp, indent=4 ) 
    logado = True           
...
def upload():
    ...
    arquivo.save(os.path.join('003/arquivos/', nome_arquivo))
